                ...
                <div class="mb-4">
                    ...
                    {:else if property.type === "boolean"}
                        <div class="flex items-center gap-2">
                            <Checkbox
                                id={propName}
                                checked={content[propName] ?? false}
                                onchange={(e) =>
                                    (content[propName] = (
                        ...
                        <div class="border p-4 rounded-lg">
                            ...
                            {#if content[propName] && content[propName].length > 0}
                                {#each content[propName] as item, index}
                                    <div
                                        class="mt-2 p-2 bg-gray-50 rounded border"
                                    >
                                ...
                                <div class="p-2 space-y-3">
                                    {#each Object.keys(property.properties) as nestedPropName}
                                        {@const nestedProperty =
                                            property.properties[nestedPropName]}
                                        <div class="mb-3">
                                            <Label
                                                for={`${propName}-${nestedPropName}`}
                                                class="text-sm"
                                            >
                                                {nestedProperty.title ||
                                                    nestedPropName}
                                            </Label>
