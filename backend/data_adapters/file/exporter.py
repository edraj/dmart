...
def meta_path(
    space_path: Path, subpath: str, file_path: str, resource_type: str
) -> Path:
    ...
    async with aopen(data_file, "a") as df, aopen(data_file_nohash, "a") as df_nohash:
        for file_name in os.listdir(path):
            ...
            try:
                ...
                logging.warning(f"File not found. The file may have been removed while the script is running. Error: {str(e)}")
                continue
