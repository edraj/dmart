...
def upgrade() -> None:
    ...
    with op.batch_alter_table("users", schema=None) as batch_op:
        batch_op.alter_column("owner_shortname", existing_type=sa.VARCHAR(), nullable=False)
        batch_op.create_unique_constraint(None, ["shortname"])  # type: ignore[arg-type]
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("users", schema=None) as batch_op:
        ...
        batch_op.drop_constraint(None, type_="unique")  # type: ignore[arg-type]
        batch_op.alter_column("owner_shortname", existing_type=sa.VARCHAR(), nullable=True)
