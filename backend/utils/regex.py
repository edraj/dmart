...
FILENAME = re.compile("^[a-zA-Z\u0621-\u064A0-9\u0660-\u0669_]{1,32}\\.(gif|png|jpeg|jpg|pdf|wsq|mp3|mp4)$")
...
EMAIL = ("^[a-zA-Z\u0621-\u064A0-9\u0660-\u0669_\\.-]+@([a-zA-Z\u0621-\u064A0-9\u0660-\u0669_-]+\\.)+"
         "[a-zA-Z\u0621-\u064A0-9\u0660-\u0669_-]{2,4}$")
META_DOC_ID = ("^[a-zA-Z\u0621-\u064A0-9\u0660-\u0669_]*:[a-zA-Z\u0621-\u064A0-9\u0660-\u0669_]"
...
INVITATION = ("^([a-zA-Z\u0621-\u064A0-9\u0660-\u0669_=]+)\\.([a-zA-Z\u0621-\u064A0-9\u0660-\u0669_=]+)"
              "\\.([a-zA-Z\u0621-\u064A0-9\u0660-\u0669_+/=-]*)$")
...
FOLDER_PATTERN = re.compile("/([a-zA-Z\u0621-\u064A0-9\u0660-\u0669_]*)/\\.dm/meta\\.folder\\.json$")
SPACES_PATTERN = re.compile("/([a-zA-Z\u0621-\u064A0-9\u0660-\u0669_]*)/\\.dm/meta\\.space\\.json$")
