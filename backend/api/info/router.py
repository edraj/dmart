...
branch = None if result is None or len(result) == 0 else result.strip()
...
version = None if result is None or len(result) == 0 else result.strip()
...
tag = None if result is None or len(result) == 0 else result.strip()
...
version_date = None if result is None or len(result) == 0 else result.strip()
