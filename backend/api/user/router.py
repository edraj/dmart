...
if settings.social_login_allowed:
    ...
    async def facebook_login(
        ...
        has_lock: bool = Body(default=False),
    ):
        user_model = await social_login(access_token, facebook_sso, "facebook", has_lock)
    ...
    async def social_login(access_token: str, sso: SSOBase, provider: str, has_lock: bool = False) -> core.User:
