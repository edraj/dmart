...
sudo dnf install python3-multipart python3-aiohttp python3-pydantic python3-json-logger python3-redis python3-jwt python3-fastapi python3-aiofiles python3-jinja2 python3-weasyprint
